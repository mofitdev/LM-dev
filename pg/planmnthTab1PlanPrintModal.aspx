<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="planmnthTab1PlanPrintModal.aspx.cs" Inherits="LMWebApp.pg.planmnthTab1PlanPrintModal" %>
...
<div style="font-size:14px; font-weight:bold; text-align:center;">
    <label id="lblHeaderGazar" runat="server" style=" font-weight:bold; text-transform: uppercase;">$$$$$</label> <label id="lblHeaderHeltes" runat="server" style=" font-weight:bold; text-transform: uppercase;">$$$$$</label> <label id="lblHeaderYear" runat="server" style=" font-weight:bold;">0000</label> ОНЫ <label id="lblHeaderMonth" runat="server" style=" font-weight:bold;">00</label> САРЫН ҮЙЛ АЖИЛЛАГААНЫ ТӨЛӨВЛӨГӨӨ 
</div>
