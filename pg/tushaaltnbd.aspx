<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tushaaltnbd.aspx.cs" Inherits="LMWebApp.pg.tushaaltnbd" %>
<style>
    .nav-tabs > li {
        font-weight:bold;
    }
...
<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
    ...
    <span>> ТӨРИЙН НАРИЙН БИЧГИЙН ДАРГЫН ТУШААЛ</span>
    </h1>
</div>
                        ...
                        <div id="pTab1t2" class="tab-pane">
                            <div class="jarviswidget" data-widget-sortable="false" data-widget-colorbutton="false" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-deletebutton="false">
                                <header>
                                    ...
                                    <h2> ТНБД-ын хяналтанд авсан заалтын төлөвлөгөө </h2>
                                    <div class="widget-toolbar"> 
                                        <div class="btn-group options" style="margin-right:0px !important;">
                                ...
                                <div>
                                    ...
                                    <div id="pTab2AddBtnDiv" runat="server" class="Colvis TableTools" style="width:62px; right:900px; top:8px; z-index:5; margin-top:1px;">
                            ...
                            <div class="jarviswidget" data-widget-sortable="false" data-widget-colorbutton="false" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-deletebutton="false">
                                ...
                                <div>
                                    ...
                                    <div class="Colvis TableTools" style="width:62px; right:120px; top:8px; z-index:5; margin-top:1px;">
                                        <button id="pTab1t3AddBtn" class="btn btn-primary btn-xs" type="button" data-target="#pTab1t3Modal" data-toggle="modal" onclick="showAddEditTab1t3(this,'нэмэх')"><i class="fa fa-plus"></i> Нэмэх</button>
                                    </div>
                            ...
                            <div style="display: block; overflow: hidden;">
                                ...
                                <div id="divpTab4t1" class="reports" style="margin:0 10px 10px 10px;">
                                    <div style="text-align: center; font-weight: bold; font: 11pt arial, sans-serif; padding-bottom: 10px; text-transform: uppercase; line-height: 20px;">
                                        ТӨРИЙН НАРИЙН БИЧГИЙН ДАРГЫН ТУШААЛЫН БИЕЛЭЛТ
                                    </div>
        ...
        <div class="modal-content">
            <form id="pTab1ModalForm">
                <div class="modal-header">
			        ...
			        <h4 class="modal-title">ТНБД-ын тушаал&nbsp;<span id="pTab1ModalHeaderLabel"></span></h4>
		        </div>
                    ...
                    <fieldset id="pTab1ZaaltModalFieldset" class="hide">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <button type="button" class="btn btn-warning btn-xs pull-right" data-target="#pTab1ZaaltModal" data-toggle="modal" onclick="showAddTab1ZaaltModal(this);"><i class="fa fa-plus"></i> Заалт нэмэх</button>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
...
<div id="pTab1SendMailModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="remoteModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
			    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
			    <h4 class="modal-title">ТНБД-ын тушаал явуулах</h4>
		    </div>
		    <div class="modal-body">
                    ...
                    <fieldset>
						<div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    <label class="control-label">*Төлөвлөгөө</label>
									<input id="pTab2ModalInputName" name="pTab2ModalInputName" type="text" class="form-control" placeholder="Төлөвлөгөө" />
                                </div>
                            </div>
                        </div>
                    </fieldset>
...
<div id="tushaaltnbdShowModal" class="modal fade in" aria-hidden="false" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" style="display:none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div id="tushaaltnbdShowModalIsShow" runat="server" class="form-group hide"></div>
                <div class="form-group" style="display:block; overflow:hidden; margin-bottom:15px;">
                    ...
                    <div id="tushaaltnbdShowModalType" runat="server" class="col-md-10">
                                    
                    </div>
                </div> 
                <div class="form-group" style="display:block; overflow:hidden; margin-bottom:15px;">
                    <label class="col-md-2 control-label">Тушаалын нэр</label>
                    <div id="tushaaltnbdShowModalTushaalName" runat="server" class="col-md-10">
                                    
                    </div>
                </div> 
                <div class="form-group" style="display:block; overflow:hidden; margin-bottom:15px;">
                    <label class="col-md-2 control-label">Батлагдсан огноо</label>
                    <div id="tushaaltnbdShowModalSuccessDate" runat="server" class="col-sm-4">
                                                                           
                    </div>
                </div>
                <div class="form-group" style="display:block; overflow:hidden; margin-bottom:15px;">
                    <label class="col-md-2 control-label">Дугаар</label>
                    <div id="tushaaltnbdShowModalNo" runat="server" class="col-md-10">
                                    
                    </div>
                </div>
                <div class="form-group" style="display:block; overflow:hidden; margin-bottom:15px;">
                    <label class="col-md-2 control-label">Боловсруулсан газар</label>
                    <div id="tushaaltnbdShowModalBolovsruulsanGazar" runat="server" class="col-sm-10">
                                    
                    </div>
                </div>
                <div class="form-group" style="display:block; overflow:hidden; margin-bottom:15px;">
                    <label class="col-md-2 control-label">Боловсруулсан ажилтан</label>
                    <div id="tushaaltnbdShowModalBolovsruulsanStaff" runat="server" class="col-sm-10">
                                    
                    </div>
                </div> 
                <div class="form-group" style="display:block; overflow:hidden; margin-bottom:15px;">
                    <label class="col-md-2 control-label">Хариуцах газар</label>
                    <div id="tushaaltnbdShowModalHariutsahGazar" runat="server" class="col-sm-10">
                                    
                    </div>
                </div> 
                <div class="form-group" style="display:block; overflow:hidden; margin-bottom:15px;">
                    <label class="col-md-2 control-label">Хариуцах ажилтан</label>
                    <div id="tushaaltnbdShowModalHariutsahStaff" runat="server" class="col-sm-10">
                                    
                    </div>
                </div> 
                <div class="form-group" style="display:block; overflow:hidden; margin-bottom:15px;">
                    <label class="col-md-2 control-label">Төлөвлөгөө</label>
                    <div id="tushaaltnbdShowModalZaalt" runat="server" class="col-sm-10">
                ...
                <div class="form-group" style="display:block; overflow:hidden; margin-bottom:15px;">
                    ...
                    <div class="col-sm-10">
                        <a id="tushaaltnbdShowModalAttach" runat="server" class="btn btn-link btn-xs" style="padding:0px; border:none;" href="#" download></a>      
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <div id="tushaaltnbdShowModalModifyDescription" runat="server" class="form-group" style="display:block; overflow:hidden; margin: 0px;">
...
<script type="text/javascript">
    ...
    var pagefunction = function () {
        ...
        globalAjaxVar = $.ajax({
            ...
            success: function (data) {
                ...
                if ($('#tushaaltnbdShowModalIsShow').text() == 'true') $('#tushaaltnbdShowModal').modal('show');
            },
    ...
    function dataBindTab1Datatable() {
        ...
        globalAjaxVar = $.ajax({
            type: "POST",
            url: "../ws/ServiceMain.svc/TushaaltnbdTab1Datatable",
                                ...
                                success: function () {
                                    if ($.trim($(el).closest('tr').find('td:eq(4)').html()) != '') {
                                        globalAjaxVar = $.ajax({
                                            ...
                                            dataType: "json",
                                            success: function () {
                                                smallBox('Тушаал', 'Хавсралт файл амжилттай устгагдлаа', '#659265', 3000);
                                            },
                                            failure: function (response) {
                                                alert('FAILURE: ' + response.d);
                                            },
                                    ...
                                    dataBindTab1Datatable();
                                    smallBox('Тушаал', 'Амжилттай устгагдлаа', '#659265', 3000);
                                },
                                failure: function (response) {
                                    alert('FAILURE: ' + response.d);
                                },
    ...
    $("#pTab1SendMailModalSave").click(function () {
        if ($.trim($('#pTab1SendMailModalSelectHariutssanStaff').val()) != '') {
                        ...
                        success: function (data) {
                            globalAjaxVar = $.ajax({
                                ...
                                success: function () {
                                    ...
                                    smallBox('Тушаал', 'Имэйл амжилттай явлаа', '#659265', 3000);
                                },
                                failure: function (response) {
                                    alert(response.d);
                                },
            ...
            //            type: "POST",
            //            url: "../ws/ServiceMain.svc/TushaalSendMail",
            //            data: '{"tushaal_ID":"' + $("#pTab1ID").html() + '", "DOMAIN_USER":"' + $.trim($('#pTab1SendMailModalSelectHariutssanStaff').val()) + '", "yr":"' + $('#pTab1SelectYear option:selected').val() + '"}',
            //            contentType: "application/json; charset=utf-8",
            //            dataType: "json",
            //            success: function () {
            //                $('#pTab1SendMailModalSave').html('<i class="fa fa-send"></i> Явуулах');
    ...
    $('#pTab1ModalForm').bootstrapValidator({
        ...
        onSuccess: function (e, data) {
            ...
            if (valBolovsruulsanGazar != 'none' && valHariutssanGazar != 'none') {
                if ($('#pTab1ModalAttachBtn').html() != 'Файл хавсаргаагүй байна...')
                    filename = "ТНБД-Тушаал " + $('#pTab1SelectYear option:selected').val() + " " + $.trim($('#pTab1ModalInputNo').val()) + "." + $('#pTab1ModalAttachBtn').html().split('.')[$('#pTab1ModalAttachBtn').html().split('.').length - 1];
                ...
                if ($('#pTab1ModalHeaderLabel').text() == 'нэмэх') {
                    if ($('#pTab1ModalZaaltTbody').find('tr').length != 0) {
                        globalAjaxVar = $.ajax({
                            type: "POST",
                            url: "../ws/ServiceMain.svc/OracleExecuteScalar",
                            data: '{"qry":"SELECT COUNT(1) FROM TBL_TUSHAAL WHERE TUSHAAL_TYPE=2 AND TO_NUMBER(TO_CHAR(TO_DATE(SUCCESS_DATE,\'yyyy-mm-dd\'),\'yyyy\'))=' + $('#pTab1SelectYear option:selected').val() + ' AND TUSHAAL_NUMBER=\'' + replaceDisplayToDatabase($.trim($('#pTab1ModalInputNo').val())) + '\'"}',
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: function (data) {
                                if (data.d != "0") alert('ДАВХАРДАЛ: ' + $('#pTab1SelectYear option:selected').val() + 'онд ' + $.trim($('#pTab1ModalInputNo').val()) + ' дугаартай тушаал орсон байна!');
                                else {
                                    globalAjaxVar = $.ajax({
                                        type: "POST",
                                        url: "../ws/ServiceMain.svc/TUSHAALS_INSERT",
                                        data: '{"P_TUSHAAL_TYPE":"2", "P_TUSHAAL_NAME":"' + replaceDisplayToDatabase($.trim($('#pTab1ModalInputName').val())) + '", "P_SUCCESS_DATE":"' + $.trim($('#pTab1ModalInputSuccessdate').val()) + '", "P_TUSHAAL_NUMBER":"' + replaceDisplayToDatabase($.trim($('#pTab1ModalInputNo').val())) + '", "P_TUSHAAL_DESCRIPTION":"' + valDescription + '", "P_FILE_URL":"' + filename + '", "P_TUSHAAL_TYPE_ID":"' + $('#pTab1ModalSelectType option:selected').val() + '", "P_BOLOVSRUULSAN_BRLIST":"' + valBolovsruulsanGazar + '", "P_BOLOVSRUULSAN_STLIST":"' + valBolovsruulsanStaff + '", "P_HARIUTSSAN_BRLIST":"' + valHariutssanGazar + '", "P_HARIUTSSAN_STLIST":"' + valHariutssanStaff + '", "P_STAFFID":"' + $('#indexUserId').html() + '", "P_ZAALTNO":"", "P_ZAALTNAME":""}',
                                        contentType: "application/json; charset=utf-8",
                                        dataType: "json",
                                        success: function () {
                                            if (filename != "none") {
                                            ...
                                            globalAjaxVar = $.ajax({
                                                type: "POST",
                                                url: "../ws/ServiceMain.svc/OracleExecuteScalar",
                                                data: '{"qry":"SELECT MAX(ID) as ID FROM TBL_TUSHAAL WHERE TUSHAAL_TYPE=2"}',
                                                contentType: "application/json; charset=utf-8",
                                                dataType: "json",
                                                success: function (data) {
                                                    valMaxID = data.d;
                                                    $("#pTab1ModalZaaltTbody tr").each(function (index) {
                                                        ...
                                                        var impl = replaceDisplayToDatabase(replaceDisplayToDatabase($(this).find('td:eq(1)').html())).substr(0, 2000);
                                                        var impl1 = replaceDisplayToDatabase(replaceDisplayToDatabase($(this).find('td:eq(1)').html())).substr(2000, 2000);
                                                        globalAjaxVar = $.ajax({
                                                            type: "POST",
                                                            
                                                            url: "../ws/ServiceMain.svc/TUSHAALS_ZAALT_INSERT",
                                                            data: '{"P_TUSHAAL_ID":"' + valMaxID + '", "P_NAME":"' + replaceDisplayToDatabase(impl) + '", "P_BOLOVSRUULSAN_BRLIST":"' + valBolovsruulsanGazar + '", "P_HARIUTSSAN_BRLIST":"' + valHariutssanGazar + '", "P_STAFFID":"' + $('#indexUserId').html() + '", "P_ENDDATE":"' + $.trim($(this).find('td:eq(2)').html()) + '"}',
                                                            contentType: "application/json; charset=utf-8",
                                                            dataType: "json",
                                                            success: function () {
                                                    ...
                                                    smallBox('ТНБД-ын тушаал', 'Амжилттай хадгалагдлаа', '#659265', 3000);
                                                },
                                                failure: function (response) {
                                                    alert('FAILURE: ' + response.d);
                                                },
                    ...
                    globalAjaxVar = $.ajax({
                        ...
                        data: '{"P_ID":"' + $('#pTab1ID').html() + '", "P_TUSHAAL_TYPE":"2", "P_TUSHAAL_NAME":"' + replaceDisplayToDatabase($.trim($('#pTab1ModalInputName').val())) + '", "P_SUCCESS_DATE":"' + $.trim($('#pTab1ModalInputSuccessdate').val()) + '", "P_TUSHAAL_NUMBER":"' + replaceDisplayToDatabase($.trim($('#pTab1ModalInputNo').val())) + '", "P_TUSHAAL_DESCRIPTION":"' + valDescription + '", "P_FILE_URL":"' + filename + '", "P_TUSHAAL_TYPE_ID":"' + $('#pTab1ModalSelectType option:selected').val() + '", "P_BOLOVSRUULSAN_BRLIST":"' + valBolovsruulsanGazar + '", "P_BOLOVSRUULSAN_STLIST":"' + valBolovsruulsanStaff + '", "P_HARIUTSSAN_BRLIST":"' + valHariutssanGazar + '", "P_HARIUTSSAN_STLIST":"' + valHariutssanStaff + '", "P_STAFFID":"' + $('#indexUserId').html() + '", "P_ZAALTNO":"", "P_ZAALTNAME":""}',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function () {
                            if (filename != "none") {
                            ...
                            dataBindTab1Datatable();
                            $('#pTab1Modal').modal('hide');
                            smallBox('Тушаал', 'Амжилттай хадгалагдлаа', '#659265', 3000);
                        },
                        failure: function (response) {
                            alert(response.d);
                        },
                ...
                alert('Боловсруулсан газар болон хариуцсан газар заавал сонгоно уу!');
                $('#pTab1ModalForm').find('.modal-footer').find(':submit').prop('disabled',false);
            }
        }
    });
    ...
    function showAddTab1ZaaltModal(el) {
        ...
        dataBindTab1ModalZaaltBolovsruulsanGazarListForSelect2('');
        dataBindTab1ModalZaaltModalHariutssanGazarListForSelect2('');
    }
        ...
        fields: {
            pTab1ZaaltModalInputName: {
                ...
                validators: {
                    ...
                    stringLength: {
                        max: 2000,
                        message: 'Уртдаа 2000 тэмдэгт авна'
                    }
                }
            },
    ...
    function dataBindTab2Datatable() {
        ...
        globalAjaxVar = $.ajax({
            type: "POST",
            url: "../ws/ServiceMain.svc/TushaaltnbdTab2Datatable",
    ...
    function dataBindTab3Datatable() {
        ...
        globalAjaxVar = $.ajax({
            type: "POST",
            url: "../ws/ServiceMain.svc/TushaaltnbdTab3Datatable",
    ...
    function dataBindTab4t1Datatable() {
        ...
        globalAjaxVar = $.ajax({
            type: "POST",
            url: "../ws/ServiceMain.svc/TushaaltnbdTab4t1Datatable",
    ...
    function dataBindTab5Datatable() {
        ...
        globalAjaxVar = $.ajax({
            type: "POST",
            url: "../ws/ServiceMain.svc/TushaaltnbdTab5Datatable",
    ...
    $('#pTab1ModalInputSuccessdate, #pTab2ModalInputEnddate, #pTab1ZaaltModalInputEnddate').datepicker({
        changeMonth: true,
        changeYear: true,
        dateFormat: 'yy-mm-dd',
