...
{
    public partial class indicatortype2 : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (ds.Tables[0].Rows.Count != 0)
                {
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        ...
                        strTableVal += "</div>";
                        strTableVal += "<a href=\"../#pg/indicator2.aspx?id=" + dr["ID"].ToString() + "\" style=\"color:#FFF;\" class=\"font-md\">" + dr["NAME"].ToString() + "</a>";
                        strTableVal += "</div>";
                        strTableVal += "</div>";
                    }
                }
                ...
                {
                    if (ds.Tables[0].Rows[0]["ROLELISTID"].ToString().Split(',')[i].ToString() == "1" || ds.Tables[0].Rows[0]["ROLELISTID"].ToString().Split(',')[i].ToString() == "38")
                    {
