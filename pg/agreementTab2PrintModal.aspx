<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="agreementTab2PrintModal.aspx.cs" Inherits="LMWebApp.pg.agreementTab2PrintModal" %>
                                        ...
                                        success: function (data) {
                                            ...
                                            globalAjaxVar = $.ajax({
                                                ...
                                                success: function (data) {
                                                    ...
                                                    var valPersUrl = '';
                                                    if ($.trim($('#indexUserPosId').html()) == '2010201' || $.trim($('#indexUserPosId').html()) == '2010301') valPersUrl = "../ws/ServiceMain.svc/AgreementIltgehHuudasLastPerHead";
                                                    ...
                                                    globalAjaxVar = $.ajax({
                                                        ...
                                                        success: function (data) {
                                                            ...
                                                            if ((parseFloat(data.d.split('~')[3]) - parseFloat(data.d.split('~')[4])).toFixed(3) > 0) $('#perfcontTab3TotalCntTotalNew').html('-' + (parseFloat(data.d.split('~')[3]) - parseFloat(data.d.split('~')[4])).toFixed(3).toString());
                                                            else $('#perfcontTab3TotalCntTotalNew').html('+' + (parseFloat(data.d.split('~')[3]) - parseFloat(data.d.split('~')[4])).toFixed(3).toString().replace(/-/g, ''));
                                                    ...
                                                    //if (totPer11 == 0) $('#perfcontTab3TotalCnt1').text((parseFloat((((parseFloat(totPer1) / (parseFloat(cntPer1) * 30)) * 100) * 0.3).toFixed(3).toString().replace('NaN', '0'))));
                                                    //else $('#perfcontTab3TotalCnt1').text((((parseFloat(totPer1) / parseFloat(cntPer1)) + (parseFloat(totPer11) / parseFloat(cntPer11))) / 2).toFixed(3));
                                                    //$('#perfcontTab3TotalCnt2').text((parseFloat(totPer2) / parseFloat(cntPer2)).toFixed(3).toString().replace('NaN', '0'));
                                                    ...
                                                    ////$('#perfcontTab3TotalCntTotal').text((parseFloat($('#perfcontTab3TotalCnt1').text()) + parseFloat($('#perfcontTab3TotalCnt2').text()) + parseFloat($('#perfcontTab3TotalCnt3').text())).toFixed(2).toString());
                                                    //globalAjaxVar = $.ajax({
                                                    //    type: "POST",
