<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="togtoolTab2ModalInfo.aspx.cs" Inherits="LMWebApp.pg.togtoolTab2ModalInfo" %>
<div class="modal-header">
    <button class="close" aria-hidden="true" data-dismiss="modal" type="button"> ×</button>
    <h4 class="modal-title" >Хяналтанд авсан заалтын төлөвлөгөөний дэлгэрэнүй</h4>
</div>
