...
{
    public partial class indicator2 : System.Web.UI.Page
    {
        ...
        protected void setDatas()
        {
            ...
            try
            {
                ...
                {
                    ds = myObj.OracleExecuteDataSet("SELECT NAME, ISACTIVE FROM TBL_INDICATORTYPE2 WHERE ID=" + Request.QueryString["id"]);
