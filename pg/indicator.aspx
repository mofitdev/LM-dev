<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="indicator.aspx.cs" Inherits="LMWebApp.pg.indicator" %>
<style type="text/css">
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <h1 class="page-title txt-color-blueDark" style="margin-bottom:12px;">
        <i class="fa-fw fa fa-home"></i> > ҮЗҮҮЛЭЛТ > 
...
<script type="text/javascript">
    ...
    function dataBindTab1DataTable() {
        ...
        globalAjaxVar = $.ajax({
            ...
            success: function (data) {
                ...
                globalAjaxVar = $.ajax({
                    type: "POST",
                    url: "../ws/ServiceMain.svc/IndicatorTab1Datatable",
    ...
    function showDeleteTab1(el) {
        globalAjaxVar = $.ajax({
            type: "POST",
            url: "../ws/ServiceMain.svc/OracleExecuteScalar",
            data: '{"qry":"SELECT COUNT(1) FROM TBL_INDICATOR_PERF WHERE INDICATOR_ID=' + $(el).closest('tr').attr('data-id') + '"}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (data) {
                if (data.d != '0') {
                    ...
                    $.SmartMessageBox({
                        ...
                        if (ButtonPressed === "Тийм") {
                            globalAjaxVar = $.ajax({
                                type: "POST",
                                url: "../ws/ServiceMain.svc/INDICATOR_DELETE",
        ...
        onSuccess: function (e, data) {
            ...
            if ($('#pTab1ModalSelect2Gazar').val() == null) {
                ...
                if ($("#pTab1ModalHeaderLabel").html() == "нэмэх") {
                    ...
                    globalAjaxVar = $.ajax({
                        type: "POST",
                        url: "../ws/ServiceMain.svc/INDICATOR_UPDATE",
                        data: '{"P_ID":"' + $("#pTab1ModalID").text() + '", "P_INDICATORTYPE_ID":"' + <%=Request.QueryString["id"]%> + '", "P_NAME":"' + replaceDisplayToDatabase($.trim($('#pTab1ModalInputName').val())) + '", "P_BASLINENAME":"' + replaceDisplayToDatabase($.trim($('#pTab1ModalInputBaslinename').val())) + '", "P_INDICATORINTERVAL_ID":"' + $('input[name="pTab1ModalInputInterval"]:checked').val() + '", "P_BRLIST":"' + $('#pTab1ModalSelect2Gazar').val() + '", "P_STAFFID":"' + $('#indexUserId').text() + '", "P_ISNUMBER":"' + $('input[name="pTab1ModalInputIsnumber"]:checked').val() + '"}',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function () {
                            dataBindTab1DataTable();
        ...
        if (funcCheckRoles('1,37')) {
            ...
            if ($.trim($(el).val()) == '') {
                if ('0' == oldval) {
                    ...
                    globalAjaxVar = $.ajax({
                        type: "POST",
                        url: "../ws/ServiceMain.svc/INDICATOR_TARGET_INSERT",
    ...
    function saveIsClosed(el) {
        ...
        globalAjaxVar = $.ajax({
            ...
            data: '{"qry":"UPDATE TBL_INDICATOR SET ISCLOSED=' + valIsSubmit + ' WHERE ID=' + $(el).closest('tr').attr('data-id') + '"}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function () {
    ...
    function dataBindTab2DataTable() {
        ...
        globalAjaxVar = $.ajax({
            type: "POST",
            url: "../ws/ServiceMain.svc/IndicatorTab2Datatable",
    ...
    function tab2TargetBlur(el, oldval) {
        ...
        if ($.trim($(el).val()) == '') {
            if ('0' == oldval) {
                ...
                globalAjaxVar = $.ajax({
                    type: "POST",
                    url: "../ws/ServiceMain.svc/INDICATOR_PERF_INSERT",
    ...
    function dataBindTab3t1DataTable() {
        ...
        globalAjaxVar = $.ajax({
            type: "POST",
            url: "../ws/ServiceMain.svc/IndicatorTab3t1Datatable",
    ...
    function dataBindTab3t2DataTable() {
        ...
        globalAjaxVar = $.ajax({
            type: "POST",
            url: "../ws/ServiceMain.svc/IndicatorTab3t2Datatable",
    ...
    function dataBindTab3t3DataTable() {
        ...
        globalAjaxVar = $.ajax({
            ...
            success: function (data) {
                ...
                globalAjaxVar = $.ajax({
                    type: "POST",
                    url: "../ws/ServiceMain.svc/IndicatorTab3t3Datatable",
                    data: '{}',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (data) {
                        ...
                        $($.parseJSON(data.d)).each(function (index, value) {
                            ...
                            valData += "<a href=\"../pg/indicatorTab3t3AttachShowModal.aspx?id=" + value.ID + "\" class=\"btn btn-default btn-xs\" data-target=\"#pTab3t3AttachShowModal\" data-toggle=\"modal\"><i class=\"fa fa-eye\"></i></a>";
                            valData += "</div>";
                            valData += "</td>";
                            valData += "<td>";
                            if (valIsEdit == '1') {
        ...
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Тийм") {
                globalAjaxVar = $.ajax({
                    type: "POST",
                    url: "../ws/ServiceMain.svc/OracleExecuteNonQuery",
                    data: '{"qry":"DELETE FROM TBL_INDICATORPDFATTACH WHERE ID=' + $(el).closest('tr').attr('data-id') + '"}',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function () {
                        if ($.trim($(el).closest('tr').find('td:eq(2)').html()) != '') {
            ...
            if ($('#pTab3t3ModalHeaderLabel').text() == 'нэмэх') {
                if ($('#pTab3t3ModalAttachBtn').html() != 'Файл хавсаргаагүй байна...') {
                    globalAjaxVar = $.ajax({
                        type: "POST",
                        url: "../ws/ServiceMain.svc/OracleExecuteScalar",
                        data: '{"qry": "SELECT NVL(MAX(ID),1) FROM TBL_INDICATORPDFATTACH"}',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (data) {
                            valMaxId = data.d;
                            filename = "ГүйцэтгэлийнҮзүүлэлт-"+valMaxId+"." + $('#pTab3t3ModalAttachBtn').html().split('.')[$('#pTab3t3ModalAttachBtn').html().split('.').length - 1];
                            globalAjaxVar = $.ajax({
                                type: "POST",
                                url: "../ws/ServiceMain.svc/OracleExecuteNonQuery",
                                data: '{"qry":"INSERT INTO TBL_INDICATORPDFATTACH (ID, NAME, FILENAME, CREATED_STAFFID, CREATED_DATE) VALUES (TBLLASTID(\'TBL_INDICATORPDFATTACH\'), \'' + replaceDisplayToDatabase($.trim($('#pTab3t3ModalInputName').val())) + '\', \'' + filename + '\', ' + $('#indexUserId').text() + ', SYSDATE)"}',
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                success: function () {
                ...
                filename = "ГүйцэтгэлийнҮзүүлэлт-" + $(el).closest('tr').attr('data-id') + "." + $('#pTab3t3ModalAttachBtn').html().split('.')[$('#pTab3t3ModalAttachBtn').html().split('.').length - 1];
                globalAjaxVar = $.ajax({
                    type: "POST",
                    url: "../ws/ServiceMain.svc/OracleExecuteNonQuery",
                    data: '{"qry":"UPDATE TBL_INDICATORPDFATTACH SET NAME=\'' + replaceDisplayToDatabase($.trim($('#pTab3t3ModalInputName').val())) + '\' WHERE ID=' + $(el).closest('tr').attr('data-id') + ')"}',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function () {
                        if ($("#pTab3t3ModalAttachInput").val() != '') {
